...
layout = html.Div([
    ...
    dcc.Graph(id="Q10_pollution-graph-2")
...
@callback(
    Output("Q10_pollution-graph-2", "figure"),
    Input("Q10_time-dropdown-2", "value"),
    Input("Q10_pollutant-dropdown-2", "value")
)
